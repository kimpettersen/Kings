...
function start(){
    $('.set_up').append('<label>Enter the amount of players: </label><input type="text" id="num" style="width:40px;"/><button onclick="set_players()">Set up game</button>');
}
function hide_help(){
    $('#help').hide();
    $('#help_button').show();
...
function set_players(){
        ...
        for(i = 0; i < window.number_of_players; i++){
            ...
            $('.set_up').append('<div class="player_names>"<label>Name of player: ' + 
                                player_number + 
                                '<input type="text" id="' + 
                                i + 
                                '" /></div>'
        ...
        $('.set_up').append('<button onclick=register_players()>Set up rules</button>');
}
